...
//   - RF 433MHz TX/RX modules (external)
//   - PN532 NFC/RFID (I2C)
//
// WIRING (cables Dupont 30cm M-F, left side of KIT B, top to bottom):
...
// =============================================
// I2C (for PN532 and other I2C modules)
// Using IO1/IO2 on right side of KIT B
// =============================================
#define GROVE_SDA 1
#define GROVE_SCL 2
...
#define TFT_INVERSION_ON 0   // ILI9341: try 0 first, set 1 if colors inverted
...
// XPT2046 calibration values (typical, adjust after testing)
...
// =============================================
// RGB LED - not present on bare ESP32-S3 N16R8
// (board has WS2812 on IO48)
// =============================================
...
// =============================================
// Audio - not available (no codec on this board)
// =============================================

// =============================================
// Battery ADC - not available on bare board
// =============================================
...
// IO38 = TX, IO39 = RX (sequential, right side)
// =============================================
#define TXLED 38
#define RXLED 39
#define LED_ON  HIGH
...
// =============================================
// RF 433MHz (right side of KIT B, after IR)
// IO35 = TX, IO36 = RX (AOKIN module)
// =============================================
#define RF_TX_PINS '{"GPIO35", 35}, {"GPIO36", 36}, {"GPIO37", 37}'
#define RF_RX_PINS '{"GPIO35", 35}, {"GPIO36", 36}, {"GPIO37", 37}'
