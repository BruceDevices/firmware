...
//   - 433MHz ASK RF TX+RX modules (external)
//   - PN532 NFC/RFID (I2C)
//
...
//
// RF 433MHz (right side of KIT B):
// IO9       |  9   | -> | RF TX DATA (nadajnik)
// IO10      | 10   | -> | RF RX DATA (odbiornik)
// =============================================================
...
// IO9  = TX DATA -> nadajnik (mala plytka, 3 piny: VCC/GND/DATA)
