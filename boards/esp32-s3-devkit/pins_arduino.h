...
// Navigation Button Pins (avoid flash/boot pins)
#define UP_BTN 33      // GPIO33
#define DOWN_BTN 34    // GPIO34
#define LEFT_BTN 35    // GPIO35
#define RIGHT_BTN 36   // GPIO36
#define SEL_BTN 37     // GPIO37 (SELECT)
#define BACK_BTN 38    // GPIO38 (BACK/ESC)

// GPIO definitions for Arduino compatibility
