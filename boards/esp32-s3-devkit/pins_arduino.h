...
#define UP_BTN 0      // GPIO 0
#define DOWN_BTN 1    // GPIO 1
#define LEFT_BTN 2    // GPIO 2
#define RIGHT_BTN 4   // GPIO 4
#define SEL_BTN 5     // GPIO 5 (SELECT)
#define BACK_BTN 6    // GPIO 6 (BACK/ESC)
